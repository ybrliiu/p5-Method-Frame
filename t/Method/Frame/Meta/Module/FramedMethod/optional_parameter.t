...
subtest new => sub {
    ...
    ok dies {
        Method::Frame::Meta::Module::FramedMethod::OptionalParameter->new('string');
    }, 'Pass not type constraint object';

    ok dies {
        Method::Frame::Meta::Module::FramedMethod::OptionalParameter->new('string', 0);
    ...
    ok lives {
        Method::Frame::Meta::Module::FramedMethod::OptionalParameter->new(Int, 0);
...
subtest validate => sub {
    ...
    subtest 'Parameter has default value' => sub {
        ...
        my $param = Method::Frame::Meta::Module::FramedMethod::OptionalParameter->new(Int, 0);
    ...
    subtest 'Optional parameter (when type constraint is not Maybe[`a])' => sub {
        ...
        my $param = Method::Frame::Meta::Module::FramedMethod::OptionalParameter->new(Int);
