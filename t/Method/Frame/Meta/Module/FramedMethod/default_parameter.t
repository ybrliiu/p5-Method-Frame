...
subtest new => sub {
    ...
    ok dies {
        Method::Frame::Meta::Module::FramedMethod::DefaultParameter->new();
    }, 'To few arguments';

    ok dies {
        Method::Frame::Meta::Module::FramedMethod::DefaultParameter->new('string', 0);
    }, 'Pass not type constraint object and default value';

    ok dies {
        Method::Frame::Meta::Module::FramedMethod::DefaultParameter->new(Int, 'string');
    }, 'Default value does not pass type constraint';

    ok lives {
        Method::Frame::Meta::Module::FramedMethod::DefaultParameter->new(Int, 0);
...
subtest validate => sub {
    ...
    my $param = Method::Frame::Meta::Module::FramedMethod::DefaultParameter->new(Int, 0);
