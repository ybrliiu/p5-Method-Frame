...
subtest new => sub {
    ...
    ok dies {
        Method::Frame::Functions::FramedMethodBuilder::DefaultParameter->new();
    }, 'To few arguments';

    ok dies {
        Method::Frame::Functions::FramedMethodBuilder::DefaultParameter->new('string', 0);
    }, 'Pass not type constraint object and default value';

    ok dies {
        Method::Frame::Functions::FramedMethodBuilder::DefaultParameter->new(Int, 'string');
    }, 'Default value does not pass type constraint';

    ok lives {
        Method::Frame::Functions::FramedMethodBuilder::DefaultParameter->new(Int, 0);
...
subtest validate => sub {
    ...
    my $param = Method::Frame::Functions::FramedMethodBuilder::DefaultParameter->new(Int, 0);
