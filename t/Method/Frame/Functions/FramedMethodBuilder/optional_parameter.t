...
subtest new => sub {
    ...
    ok dies {
        Method::Frame::Functions::FramedMethodBuilder::OptionalParameter->new();
    }, 'Too few arguments';

    ok dies {
        Method::Frame::Functions::FramedMethodBuilder::OptionalParameter->new(Int);
    ...
    ok lives {
        ...
        Method::Frame::Functions::FramedMethodBuilder::OptionalParameter->new(Maybe[Int]);
...
subtest validate => sub {
    ...
    my $param = Method::Frame::Functions::FramedMethodBuilder::OptionalParameter->new(Maybe[Int]);
