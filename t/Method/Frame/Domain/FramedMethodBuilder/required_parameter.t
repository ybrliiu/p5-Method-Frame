...
subtest new => sub {
    ...
    ok dies {
        Method::Frame::Domain::FramedMethodBuilder::RequiredParameter->new();
    }, 'No arguments';

    ok dies {
        Method::Frame::Domain::FramedMethodBuilder::RequiredParameter->new('string')
    }, 'Pass not type constraint object';

    ok lives {
        Method::Frame::Domain::FramedMethodBuilder::RequiredParameter->new(Int);
...
subtest validate => sub {
    ...
    my $param = Method::Frame::Domain::FramedMethodBuilder::RequiredParameter->new(Int);
