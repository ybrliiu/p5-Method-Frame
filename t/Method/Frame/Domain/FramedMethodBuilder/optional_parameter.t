...
subtest new => sub {
    ...
    ok dies {
        Method::Frame::Domain::FramedMethodBuilder::OptionalParameter->new();
    }, 'Too few arguments';

    ok dies {
        Method::Frame::Domain::FramedMethodBuilder::OptionalParameter->new(Int);
    ...
    ok lives {
        ...
        Method::Frame::Domain::FramedMethodBuilder::OptionalParameter->new(Maybe[Int]);
...
subtest validate => sub {
    ...
    my $param = Method::Frame::Domain::FramedMethodBuilder::OptionalParameter->new(Maybe[Int]);
