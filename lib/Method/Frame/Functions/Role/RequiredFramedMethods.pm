package Method::Frame::Functions::Role::RequiredFramedMethods;
...
sub new {
    ...
    {
        state $constraint = do {
            my $class_name = 'Method::Frame::Functions::Role::RequiredFramedMethod';
...
sub _has {
    ...
    Carp::croak 'Argument is not RequiredFramedMethod object.'
        unless $required_framed_method->isa('Method::Frame::Functions::Role::RequiredFramedMethod');
...
sub are_implemented {
    ...
    Carp::croak 'Argument is not FrameMethods object'
        unless Method::Frame::Util::object_isa($framed_methods, 'Method::Frame::Functions::Role::FramedMethods');
