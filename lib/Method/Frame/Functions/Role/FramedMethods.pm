package Method::Frame::Functions::Role::FramedMethods;
...
sub new {
    ...
    {
        state $constraint = do {
            my $class_name = 'Method::Frame::Functions::Role::FramedMethod';
...
sub has {
    ...
    Carp::croak 'Argument is not FrameMethod object.'
        unless $framed_method->isa('Method::Frame::Functions::ComparisonFrame');
...
sub add {
    ...
    my ($self, $framed_method) = @_;
    Carp::croak 'Argument is not FrameMethod object.'
        unless $framed_method->isa('Method::Frame::Functions::Role::FramedMethod');
