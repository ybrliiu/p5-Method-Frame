package Method::Frame::Functions::Class::FramedMethods;
...
sub new {
    ...
    {
        state $constraint = do {
            my $class_name = 'Method::Frame::Functions::Class::FramedMethod';
...
sub has {
    ...
    Carp::croak 'Parameter does not FrameMethod object.'
        unless $framed_method->isa('Method::Frame::Functions::Class::FramedMethod');
